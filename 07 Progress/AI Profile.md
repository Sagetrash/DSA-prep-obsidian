...
* **Volume Solved**: 10 (Contains Duplicate, Valid Anagram, Search Insert Position, Valid Palindrome, Best Time to Buy and Sell Stock, Squares of a Sorted Array, Move Zeroes, Remove Duplicates from Sorted Array, Find Minimum in Rotated Sorted Array, Merge Two Sorted Lists)
* **Independent Solve Rate**: 88.9% (24/27 unassisted passes)
* **Average Solving Time**: 10.2 mins (Full Problem Presentation $\to$ Code Submission Window)
